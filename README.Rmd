...
if (params$download_material == "TRUE") {
  glue::glue("- [Clique aqui](https://curso-r.github.io/202304-relatorios/materiais/material_do_curso.zip) para baixar o material do curso.")
}
```
...
"praticas/" |>
  fs::dir_ls(fail = FALSE) |>
  path_to_url() |>
  dplyr::filter(stringr::str_detect(url, ".zip")) |> 
  dplyr::select(Exemplo = url) |>
  knitr::kable()
```
